...
<head>
	<meta charset="utf-8">
  	...
  	<link rel="icon" type="image/png" href="${request.contextPath}/i/favicon.png">
    	...
    	<div class="am-offcanvas-bar admin-offcanvas-bar">
      		<ul class="am-list admin-sidebar-list">
        		...
        		<li class="admin-parent">
          			<a class="am-cf" data-am-collapse="{target: '#collapse-nav'}"><span class="am-icon-file"></span> 账户管理 <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
          			<ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
            			<li><a href="admin_edit" class="am-cf"><span class="am-icon-check"></span> 管理员资料<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
            			<li><a href="user_manage"><span class="am-icon-puzzle-piece"></span> 用户管理</a></li>
            			<li><a href="admin-gallery.html"><span class="am-icon-th"></span> 订单管理<span class="am-badge am-badge-secondary am-margin-right am-fr">24</span></a></li>
            			<li><a href="admin-log.html"><span class="am-icon-calendar"></span> 系统日志</a></li>
            			<li><a href="admin-404.html"><span class="am-icon-bug"></span> 404</a></li>
          			</ul>
        		</li>
        		<li><a href="books"><span class="am-icon-table"></span> 图书管理</a></li>
