      ...
      <ul class="am-list admin-sidebar-list">
        ...
        <li class="admin-parent">
          ...
          <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
            <li><a href="admin" class="am-cf"><span class="am-icon-check"></span> 管理员资料<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
            <li><a href="user"><span class="am-icon-puzzle-piece"></span> 用户管理</a></li>
