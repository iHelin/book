            ...
            <div class="am-g book-content">
                ...
                <div class="am-u-lg-7">
                    ...
                    <div>
                        ...
                        <p>作者：${book.author!}</p>
                        <p>价格：
                            <del><strong>${book.price!?string.currency}</strong></del>
                        </p>
                    </div>
                    <div>
                        <p>促销价：<span
                                style="font-size:30px;color:#ff4400"><strong>${book.promotionPrice!?string.currency}</strong></span>
                        </p>
                    </div>
                    <div>
                        <p>
                            ...
                            <div class="am-u-sm-4 am-fl" style="float:left;">
                                <div class="am-input-group">
							      		<span class="am-input-group-btn">
        									<button class="am-btn am-btn-default am-btn-xs input-num-down"
                                                    id="book_down_btn" type="button" onclick="count(this);"><span
                                                    class="am-icon-minus"></span> </button>
      									</span>
                                    <input type="text" value="1" class="am-form-field am-text-center" id="book_count"
                                           data-step="1" data-max="${book.number!}" data-min="1"
                                           onkeyup='this.value=this.value.replace(/\D/gi,"")' readOnly>
                                    <span class="am-input-group-btn">
        									<button class="am-btn am-btn-default am-btn-xs input-num-up"
                                                    id="book_up_btn" type="button" onclick="count(this);"><span
                    ...
                    <div class="am-text-center">
                        <button class="am-btn am-btn-danger" style="margin-right: 40px;" onclick="go(#{book.id!})">
                            立即购买
                        </button>
                        ...
                        <div class="am-tabs" data-am-tabs="{noSwipe: 1}" style="margin-top:20px">
                            ...
                            <div class="am-tabs-bd">
                                ...
                                <div class="am-tab-panel">
                                    <div id="SOHUCS" sid="#{book.id!0}"></div>
                                </div>
                            </div>
                        </div>
                    </div>
